...
font_path = '../static/fonts/Mocking Bird/mocking_bird.ttf'
text = "Mon prénom"
...
# Process
mesh = ring(text, diameter, height, thickness, res, font_path, output_path, filename, shape=1, brand=True, vis=False)
