...
class TestText2SVG(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.font_path = os.path.join(os.path.dirname(__file__), '..', 'static', 'fonts', 'Allison', 'Allison-Regular.ttf')
    ...
    def test_text_svg(self):
        ...
        svg_text = text_svg(text, self.font_path, font_size, zoneWidth_mm - x_mm, zoneHeight_mm - y_mm, x_mm, y_mm, interline_ratio=interline_ratio)
        svg_text.unit = 'mm'
