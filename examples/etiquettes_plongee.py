...
def batch_tags(data, RV = False):
    ...
    for item in data:
        ...
        cairosvg.svg2png(url=output_1_r, write_to=os.path.join(output_path, nom_fichier + '_A.png'))
        ...
        if RV == True:
            tag_3D_RV(nom_fichier + '_A_txt', nom_fichier + '_B_txt', input_path, output_path)
        else:
...
if __name__ == "__main__":
    ...
    FR = [
        ...
        {"Catégorie": "Basique", "Id": 2, "Recto": "Quelle pression ?", "Verso": "Mi-pression Réserve"},
    ...
    EN = [
        ...
        {"Catégorie": "Basic", "Id": 2, "Recto": "How much air?", "Verso": "Half tank Low on air"},
        {"Catégorie": "Basic", "Id": 3, "Recto": "Compensate", "Verso": "Watch out for fauna"},
        {"Catégorie": "Basic", "Id": 4, "Recto": "Wait", "Verso": "Slow down"},
        {"Catégorie": "Safety", "Id": 1, "Recto": "Are you ok?", "Verso": "I'm not ok!"},
        {"Catégorie": "Safety", "Id": 2, "Recto": "Out of breathe", "Verso": "Out of air"},
        ...
        {"Catégorie": "Autonomy", "Id": 1, "Recto": "Boat", "Verso": "Surface marker buoy"},
        ...
        {"Catégorie": "Buoyancy", "Id": 3, "Recto": "Higher dump valve", "Verso": "Lower dump valve"},
        {"Catégorie": "Buoyancy", "Id": 4, "Recto": "Ascend", "Verso": "Descend"},
        {"Catégorie": "Breathing", "Id": 1, "Recto": "Stop breathing", "Verso": "Breathe"},
        {"Catégorie": "Breathing", "Id": 2, "Recto": "Full lungs", "Verso": "Empty lungs"},
