...
class SVG:
    ...
    def extract_elements_and_transforms(
        self, content, parent_translate=[0.0, 0.0], parent_scale=1.0
    ):
        ...
        for group_match in group_matches:
            ...
            self.extract_elements_and_transforms(
                group_content, combined_translate, combined_scale
            )
        ...
        if not group_matches:
            self.extract_and_add_elements("path", content, parent_translate, parent_scale)
